...
export default function Hero() {
  ...
  return (
    <section ref={containerRef} className="bg-linear-to-br from-white via-blue-50/40 to-white pt-0 pb-8 sm:pb-12 md:pb-16 px-4 sm:px-6 relative overflow-hidden min-h-screen flex items-center justify-center">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-linear-to-br from-blue-400/35 to-blue-200/15 rounded-full blur-3xl" style={{
        ...
        <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-linear-to-tr from-blue-300/25 to-blue-100/15 rounded-full blur-3xl" style={{
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-linear-to-b from-blue-200/15 to-transparent rounded-full blur-3xl" style={{
      ...
      <div className="absolute inset-0 pointer-events-none hidden sm:block">
        ...
        <div className="absolute top-1/4 left-0 w-64 h-0.5 bg-linear-to-r from-blue-400/0 via-blue-400/30 to-blue-400/0" style={{
          animation: 'shimmer 3s ease-in-out infinite'
        }}></div>

        {/* Bottom right accent line */}
        <div className="absolute bottom-1/3 right-0 w-80 h-0.5 bg-linear-to-l from-blue-300/0 via-blue-300/25 to-blue-300/0" style={{
      ...
      <div className="absolute inset-0 pointer-events-none hidden sm:block">
        <div className="absolute top-20 right-10 w-64 sm:w-96 h-64 sm:h-96 bg-linear-to-br from-blue-400/15 to-blue-200/5 rounded-full blur-3xl" style={{
          transform: `translate(${mousePosition.x}px, ${mousePosition.y}px)`,
          transition: 'transform 0.3s ease-out'
        }}></div>
        <div className="absolute bottom-10 left-1/4 w-56 sm:w-80 h-56 sm:h-80 bg-linear-to-tr from-blue-300/10 to-blue-100/3 rounded-full blur-3xl" style={{
          transform: `translate(${-mousePosition.x * 0.5}px, ${-mousePosition.y * 0.5}px)`,
          transition: 'transform 0.3s ease-out'
        }}></div>
      </div>
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10 w-full">
        ...
        >
          ...
          <span className="inline-block">
            <span className="relative inline-block">
              <span className="bg-linear-to-r from-blue-600 via-blue-500 to-blue-400 bg-clip-text text-transparent font-black">Web Applications</span>
              <span className="absolute inset-0 bg-linear-to-r from-blue-600 via-blue-500 to-blue-400 blur-xl opacity-20 -z-10" style={{
                animation: 'pulse 3s cubic-bezier(0.4, 0, 0.6, 1) infinite'
              }}></span>
              {/* Animated underline */}
              <div className="absolute bottom-0 left-0 h-1 bg-linear-to-r from-blue-600 to-blue-400 rounded-full" style={{
                width: '0%',
        ...
        >
          Partner with us to deliver stunning, <span className="font-semibold text-gray-900 relative">
            ...
            <div className="absolute bottom-0 left-0 h-0.5 w-full bg-linear-to-r from-blue-500/0 via-blue-500/50 to-blue-500/0" style={{
        ...
        <div ref={buttonsRef} className="opacity-0 flex flex-col sm:flex-row items-center justify-center gap-3 w-full sm:w-auto">
          ...
          >
            ...
            <div className="absolute inset-0 bg-linear-to-r from-blue-500/0 via-white/20 to-blue-500/0" style={{
