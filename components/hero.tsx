  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div
          className="absolute -top-40 -right-40 w-80 h-80 bg-linear-to-br from-blue-400/35 to-blue-200/15 rounded-full blur-3xl"
          style={{
        ...
        <div
          className="absolute -bottom-40 -left-40 w-96 h-96 bg-linear-to-tr from-blue-300/25 to-blue-100/15 rounded-full blur-3xl"
          style={{
        ...
        <div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-linear-to-b from-blue-200/15 to-transparent rounded-full blur-3xl"
          style={{
      ...
      <div className="absolute inset-0 pointer-events-none hidden sm:block">
        ...
        <div
          className="absolute top-1/4 left-0 w-64 h-0.5 bg-linear-to-r from-blue-400/0 via-blue-400/30 to-blue-400/0"
          style={{
        ...
        <div
          className="absolute bottom-1/3 right-0 w-80 h-0.5 bg-linear-to-l from-blue-300/0 via-blue-300/25 to-blue-300/0"
          style={{
      ...
      <div className="absolute inset-0 pointer-events-none hidden sm:block">
        ...
        ></div>
        <div
          className="absolute top-1/3 left-1/3 w-1.5 h-1.5 bg-blue-500 rounded-full"
          style={{
        ...
        ></div>
        <div
          className="absolute bottom-1/4 right-1/3 w-1 h-1 bg-blue-300 rounded-full"
          style={{
      ...
      <div className="absolute inset-0 pointer-events-none hidden sm:block">
        <div
          className="absolute top-20 right-10 w-64 sm:w-96 h-64 sm:h-96 bg-linear-to-br from-blue-400/15 to-blue-200/5 rounded-full blur-3xl"
          style={{
            transform: `translate(${mousePosition.x}px, ${mousePosition.y}px)`,
            transition: "transform 0.3s ease-out",
          }}
        ></div>
        <div
          className="absolute bottom-10 left-1/4 w-56 sm:w-80 h-56 sm:h-80 bg-linear-to-tr from-blue-300/10 to-blue-100/3 rounded-full blur-3xl"
          style={{
            transform: `translate(${-mousePosition.x * 0.5}px, ${-mousePosition.y * 0.5}px)`,
            transition: "transform 0.3s ease-out",
          }}
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10 w-full">
        ...
        <div className="flex items-center justify-center gap-3 mb-4 sm:mb-5 opacity-0 animate-slide-in-up">
          <div className="w-1.5 h-1.5 bg-linear-to-r from-blue-400 to-blue-300 rounded-full"></div>
          <span className="text-xs sm:text-sm font-medium text-gray-500 uppercase tracking-widest">
            Tech Partner for Agencies
          </span>
          <div className="w-1.5 h-1.5 bg-linear-to-r from-blue-300 to-blue-400 rounded-full"></div>
        </div>
        ...
        >
          ...
          <span className="inline-block">
            <span className="relative inline-block">
              <span className="bg-linear-to-r from-blue-600 via-blue-500 to-blue-400 bg-clip-text text-transparent font-black">
                Web Applications
              </span>
              <span
                className="absolute inset-0 bg-linear-to-r from-blue-600 via-blue-500 to-blue-400 blur-xl opacity-20 -z-10"
                style={{
              ...
              <div
                ...
                style={{
                  width: "0%",
                  animation:
                    "expandWidth 1.5s cubic-bezier(0.25, 0.46, 0.45, 0.94) 0.5s forwards",
                }}
              ></div>
            </span>
          </span>
        ...
        >
          ...
          <span className="font-semibold text-gray-900 relative">
            ...
            <div
              className="absolute bottom-0 left-0 h-0.5 w-full bg-linear-to-r from-blue-500/0 via-blue-500/50 to-blue-500/0"
              style={{
        ...
        <div
          ref={trustRef}
          className="opacity-0 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-5 md:gap-7 mb-6 sm:mb-8 flex-wrap"
        >
          {[
            ...
            >
              <div className="w-5 h-5 bg-linear-to-br from-blue-600 to-blue-500 rounded-full flex items-center justify-center shrink-0 shadow-lg group-hover:shadow-blue-500/50 transition-all text-xs font-bold text-white">
                {item.icon}
              </div>
              <span className="text-black font-semibold text-xs sm:text-sm group-hover:text-blue-700 transition-colors">
                {item.label}
              </span>
            </div>
          ))}
        ...
        <div
          ref={buttonsRef}
          className="opacity-0 flex flex-col sm:flex-row items-center justify-center gap-3 w-full sm:w-auto"
        >
          <button
          ...
          >
            ...
            <div
              className="absolute inset-0 bg-linear-to-r from-blue-500/0 via-white/20 to-blue-500/0"
              style={{
        ...
        <div
          className="hidden sm:flex absolute left-1/2 -translate-x-1/2 flex-col items-center gap-1 opacity-50 hover:opacity-100 transition-opacity cursor-pointer group"
          onClick={() =>
            document
        ...
        >
          ...
          <div className="w-5 h-8 border border-gray-400 rounded-full flex items-center justify-center group-hover:border-blue-500 transition-colors">
            <div
              className="w-0.5 h-1.5 bg-gray-400 rounded-full group-hover:bg-blue-500 transition-colors"
              style={{
